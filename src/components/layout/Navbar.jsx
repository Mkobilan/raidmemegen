                ...
                <div className="flex items-center justify-between h-16">
                    ...
                    <div className="flex items-center shrink-0">
                        <motion.div
                            ...
                            onClick={() => navigate('/')}
                        >
                            <h1 className="text-2xl font-gamer font-bold text-transparent bg-clip-text bg-gradient-to-r from-raid-neon to-blue-500 hidden sm:block">
                                RAID GEN
                            </h1>
                            <h1 className="text-2xl font-gamer font-bold text-transparent bg-clip-text bg-gradient-to-r from-raid-neon to-blue-500 sm:hidden">
                                RG
                            </h1>
                        </motion.div>
                    ...
                    <div className="flex items-center gap-4">
                        <div className="hidden md:flex items-center">
                            {user ? (
                                <>
                                    <div className="text-gray-300 flex items-center bg-gray-800 px-3 py-1 rounded-full border border-gray-700 mr-2">
            ...
            <AnimatePresence>
                {isOpen && (
                    <motion.div
                        ...
                        className="bg-gray-800 border-b border-gray-700 overflow-hidden absolute top-[calc(100%+0px)] right-0 w-full md:w-64 md:right-4 md:rounded-b-lg md:border-x md:shadow-xl z-30 rounded-b-xl"
                    >
