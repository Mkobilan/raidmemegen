...
export default async function handler(req, res) {
    ...
    // Explicitly handle options for CORS if needed, but here just standard POST
    if (req.method !== 'POST') {
    ...
    try {
        ...
        if (authError || !user) {
            console.error('[API] create-checkout: Auth error', authError);
        ...
        console.error('[API] create-checkout: Internal Catch', err);
